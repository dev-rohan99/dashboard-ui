            ...
            <div className="container-fluid mainElement d-flex justify-content-center align-items-center">
                <div className="container">
                    <div className="row shadow-lg">
                        <div className="col-md-6 d-flex justify-content-center text-center align-items-center signupLeft rounded-start">
                        ...
                        <div className="col-md-6 d-flex justify-content-center text-center align-items-center signupRight rounded-end">
                            <div className="py-5 px-3 w-100">
                                ...
                                <form action="">
                                    <div className="mb-3 text-start">
                                        <input type="text" className="form-control py-2" id="name" placeholder="Name"/>
                                    </div>
                                    <div className="mb-3 text-start">
